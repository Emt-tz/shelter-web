...
class MobileFooterSection extends StatefulWidget {
  const MobileFooterSection({Key? key}) : super(key: key);

  @override
  _MobileFooterSectionState createState() => _MobileFooterSectionState();
}

class _MobileFooterSectionState extends State<MobileFooterSection> {
  @override
